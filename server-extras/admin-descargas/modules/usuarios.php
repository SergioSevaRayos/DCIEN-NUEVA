                    ...
                    <tr>
                        <td style="padding:0 50px 50px 50px;">
                            ...
                            <p style="margin:0 0 30px 0;color:#a3a3a3;font-size:13px;line-height:1.8;text-align:center;letter-spacing:0.3px;">
                                Aplica el código <strong style="color:#ffffff;font-family:monospace;">' . htmlspecialchars($code) . '</strong> durante el proceso de checkout para acceder al activo con tu descuento.
                            </p>
