 ...
 * Datos esperados: username, order_id, product_name, unit_number, size, color, type,
 *                  shipping_address, total, discount_code (opcional), discount_amount (opcional)
 */

// Construir bloque de descuento solo si existe
$discount_html = '';
                            ...
                            <table role="presentation" style="width: 100%; border-collapse: collapse; background-color: #f8f8f8; margin: 25px 0;" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding: 30px;">
                                        ...
                                        <table role="presentation" style="width: 100%;" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="padding: 8px 0; color: #666666; font-size: 14px;">Producto:</td>
                                                <td align="right" style="padding: 8px 0; color: #000000; font-size: 14px; font-weight: 600;">{product_name}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0; color: #666666; font-size: 14px;">Unidad:</td>
                                                <td align="right" style="padding: 8px 0; color: #000000; font-size: 18px; font-weight: 700; font-family: monospace;">#{unit_number}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0; color: #666666; font-size: 14px;">Talla:</td>
                                                <td align="right" style="padding: 8px 0; color: #000000; font-size: 14px; font-weight: 600;">{size}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0; color: #666666; font-size: 14px;">Color:</td>
                                                <td align="right" style="padding: 8px 0; color: #000000; font-size: 14px; font-weight: 600;">{color}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0; color: #666666; font-size: 14px;">Tipo:</td>
                                                <td align="right" style="padding: 8px 0; color: #000000; font-size: 14px; font-weight: 600;">{type}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding: 25px;">
                                        ...
                                        <p style="margin: 0; color: #1e3a8a; font-size: 13px; line-height: 1.7;">
                                            ...
                                            2. Cuando este listo te avisaremos (7 días máx.)<br>
